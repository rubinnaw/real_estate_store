export function render(obj, isFav){
    ...
    <div class="object">
        ...
        <div class="object__desc">
            ...
            <div class="object__desc-name">
                ...
                <button id="addToFavs" class="button-favourite ${isFav ? 'button-favourite--active' : ''}">
...
export function toggleFavButton(isFav){
    const btn = document.querySelector('#addToFavs')
    if (isFav){
